...
clear all
addpath(genpath('/rri_disks/artemis/meltzer_lab/NIBS_treatment/meg/behavioural_data/wordrep_paradigm/stim_creation/2017-02-09_stim_selection'));
% Set a random seed
setSeed(50);

% Create population (master word list)
wordrep_Population = population('2017-02-27_updated_population_allvars_lemmatized_manualcheck.txt', ...
