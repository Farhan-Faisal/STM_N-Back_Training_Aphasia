...
wordrep_Population = population('masterlist3.txt', 'name', 'wordrep_Population', 'isHeader',true, 'isFormatting', true);
...
Sample1 = sample(p.nsampcnt,'name','Sample1','outFile',['wordrep_masterlist3' p.samplein '_' p.optmethod '_run1.txt']);
Sample2 = sample(p.nsampcnt,'name','Sample2','outFile',['wordrep_masterlist3' p.samplein '_' p.optmethod '_run2.txt']);
Sample3 = sample(p.nsampcnt,'name','Sample3','outFile',['wordrep_masterlist3' p.samplein '_' p.optmethod '_run3.txt']);
Sample4 = sample(p.nsampcnt,'name','Sample4','outFile',['wordrep_masterlist3' p.samplein '_' p.optmethod '_run4.txt']);
Sample5 = sample(p.nsampcnt,'name','Sample5','outFile',['wordrep_masterlist3' p.samplein '_' p.optmethod '_run5.txt']);
