% - create correlation-matching z-test dialog
%
...
function varargout = createMatchCorrelztest_Dialog(varargin)
% CREATEMATCHCORRELZTEST_DIALOG M-file for createMatchCorrelztest_Dialog.fig
%      CREATEMATCHCORRELZTEST_DIALOG, by itself, creates a new CREATEMATCHCORRELZTEST_DIALOG or raises the existing
%      singleton*.
%
%      H = CREATEMATCHCORRELZTEST_DIALOG returns the handle to a new CREATEMATCHCORRELZTEST_DIALOG or the handle to
%      the existing singleton*.
%
%      CREATEMATCHCORRELZTEST_DIALOG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CREATEMATCHCORRELZTEST_DIALOG.M with the given input arguments.
%
%      CREATEMATCHCORRELZTEST_DIALOG('Property','Value',...) creates a new CREATEMATCHCORRELZTEST_DIALOG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before createMatchCorrelztest_Dialog_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to createMatchCorrelztest_Dialog_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help createMatchCorrelztest_Dialog

% Last Modified by GUIDE v2.5 13-Aug-2011 22:36:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @createMatchCorrelztest_Dialog_OpeningFcn, ...
                   'gui_OutputFcn',  @createMatchCorrelztest_Dialog_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before createMatchCorrelztest_Dialog is made visible.
function createMatchCorrelztest_Dialog_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to createMatchCorrelztest_Dialog (see VARARGIN)

% Choose default command line output for createMatchCorrelztest_Dialog
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes createMatchCorrelztest_Dialog wait for user response (see UIRESUME)
% uiwait(handles.figure_createMatchCorrelztest_Dialog);


% --- Outputs from this function are returned to the command line.
function varargout = createMatchCorrelztest_Dialog_OutputFcn(hObject, eventdata, handles) 
                            ...
                            if create == true
                               ...
                               if create == true
                                    ...
                                    if create == true
                                        ...
                                        verbosePrint(['Executing command: ','''',command,''''],'createMatchCorrelztest_Dialog_create');
                                        evalin('base',command);      
                                         close(handles.figure_createMatchCorrelztest_Dialog);
                                    end
                               end
                            end
                        end
