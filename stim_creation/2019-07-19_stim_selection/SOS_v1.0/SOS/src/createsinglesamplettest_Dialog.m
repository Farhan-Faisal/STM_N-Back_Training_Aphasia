% - create single sample t-test dialog
%
...
function varargout = createsinglesamplettest_Dialog(varargin)
% CREATESINGLESAMPLETTEST_DIALOG M-file for createsinglesamplettest_Dialog.fig
%      CREATESINGLESAMPLETTEST_DIALOG, by itself, creates a new CREATESINGLESAMPLETTEST_DIALOG or raises the existing
%      singleton*.
%
%      H = CREATESINGLESAMPLETTEST_DIALOG returns the handle to a new CREATESINGLESAMPLETTEST_DIALOG or the handle to
%      the existing singleton*.
%
%      CREATESINGLESAMPLETTEST_DIALOG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CREATESINGLESAMPLETTEST_DIALOG.M with the given input arguments.
%
%      CREATESINGLESAMPLETTEST_DIALOG('Property','Value',...) creates a new CREATESINGLESAMPLETTEST_DIALOG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before createsinglesamplettest_Dialog_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to createsinglesamplettest_Dialog_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help createsinglesamplettest_Dialog

% Last Modified by GUIDE v2.5 15-Sep-2010 18:19:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @createsinglesamplettest_Dialog_OpeningFcn, ...
                   'gui_OutputFcn',  @createsinglesamplettest_Dialog_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before createsinglesamplettest_Dialog is made visible.
function createsinglesamplettest_Dialog_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to createsinglesamplettest_Dialog (see VARARGIN)

% Choose default command line output for createsinglesamplettest_Dialog
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes createsinglesamplettest_Dialog wait for user response (see UIRESUME)
% uiwait(handles.figure_createsinglesamplettest_Dialog);


% --- Outputs from this function are returned to the command line.
function varargout = createsinglesamplettest_Dialog_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pushbutton_create_ttest.
function pushbutton_create_ttest_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_create_ttest (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
        ...
        if create == true
            ...
            if isempty(sample1) == 0
                ...
                if isempty(sample1Col) == 0
                    create = validate_targValue(handles);
                    
                    if create == true
                        targValue = get(handles.edit_targValue,'String');
                            ...
                            if create == true
                                ...
                                verbosePrint(['Executing command: ','''',command,''''],'createsinglesamplettest_Dialog_create');
                                evalin('base',command);      
                                close(handles.figure_createsinglesamplettest_Dialog);
...
function edit_targValue_Callback(hObject, eventdata, handles)
% hObject    handle to edit_targValue (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_targValue as text
%        str2double(get(hObject,'String')) returns contents of edit_targValue as a double
    validate_targValue(handles);
    
    
function flag = validate_targValue(handles)
     str = get(handles.edit_targValue,'String');
...
% --- Executes during object creation, after setting all properties.
function edit_targValue_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_targValue (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
