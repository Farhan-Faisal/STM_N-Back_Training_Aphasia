...
function varargout = create2samplettest_Dialog(varargin)
% CREATE2SAMPLETTEST_DIALOG M-file for create2samplettest_Dialog.fig
%      CREATE2SAMPLETTEST_DIALOG, by itself, creates a new CREATE2SAMPLETTEST_DIALOG or raises the existing
%      singleton*.
%
%      H = CREATE2SAMPLETTEST_DIALOG returns the handle to a new CREATE2SAMPLETTEST_DIALOG or the handle to
%      the existing singleton*.
%
%      CREATE2SAMPLETTEST_DIALOG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CREATE2SAMPLETTEST_DIALOG.M with the given input arguments.
%
%      CREATE2SAMPLETTEST_DIALOG('Property','Value',...) creates a new CREATE2SAMPLETTEST_DIALOG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before create2samplettest_Dialog_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to create2samplettest_Dialog_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help create2samplettest_Dialog

% Last Modified by GUIDE v2.5 13-Aug-2011 22:59:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @create2samplettest_Dialog_OpeningFcn, ...
                   'gui_OutputFcn',  @create2samplettest_Dialog_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before create2samplettest_Dialog is made visible.
function create2samplettest_Dialog_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to create2samplettest_Dialog (see VARARGIN)

% Choose default command line output for create2samplettest_Dialog
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes create2samplettest_Dialog wait for user response (see UIRESUME)
% uiwait(handles.figure_create2samplettest_Dialog);


% --- Outputs from this function are returned to the command line.
function varargout = create2samplettest_Dialog_OutputFcn(hObject, eventdata, handles) 
                    ...
                    if isempty(sample2) == 0
                        ...
                        if isempty(sample2Col) == 0
                            ...
                            if create == true
                                ...
                                verbosePrint(['Executing command: ','''',command,''''],'create2samplettest_Dialog_create');
                                evalin('base',command);      
                                 close(handles.figure_create2samplettest_Dialog);
...
% --- Executes on key press with focus on pushbutton_refreshSample1List and none of its controls.
function pushbutton_refreshSample1List_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_refreshSample1List (see GCBO)
...
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over pushbutton_refreshSample1List.
function pushbutton_refreshSample1List_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_refreshSample1List (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function pushbutton_refreshSample1List_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_refreshSample1List (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
