...
# Now we have more words that have syllable information, so we're going to
# segment out the 1- and 3- syllable words from goodnounsandverbs before
# entering them into N-Watch to collect other pieces of linguistic information.
...
# So now we put the words from rightnounsandverbs into N-Watch to pull out the
# other linguistic info that we are looking for.

################################################################################
# STEP 3 - COMBINE FREQUENCY NORMS WITH OTHER LING INFO FROM N-WATCH           #
################################################################################

# Jed use Python to extract just the lemmas from the list of words.

# Here, I combine the orthographic information from N-Watch with the frequency
# and syllable information from SUBLTEX-US and CMU.
